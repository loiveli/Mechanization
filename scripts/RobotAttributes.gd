...
enum partType {NULL,ROBOT_LEG, ROBOT_ARM, ROBOT_HEAD, ROBOT_BODY}
...
func _init(p_name = "", p_speed = 1, p_output = partType.ROBOT_LEG, p_input = partType.NULL, p_personality = personalityTrait.OPEN_SOURCE):
	name = p_name
	outputSpeed = p_speed
	output = p_output
	input = p_input
